...
const Hero = () => {
  return (
    <section id="home" className="vh-100 d-flex align-items-center position-relative overflow-hidden">
        ...
        <Row className="align-items-center justify-content-center text-center">
          <Col lg={10} className="z-2">
            <div data-aos="fade-up" data-aos-duration="1000">
              ...
              <h1 className="fw-bold ls-tight mb-4 text-uppercase" style={{ lineHeight: '0.8', fontSize: 'clamp(4rem, 12vw, 10rem)' }}>
                SANKARA<br />NARAYANAN
              </h1>
              <h3 className="fw-light mb-5" style={{ fontSize: 'clamp(1.5rem, 4vw, 3rem)', letterSpacing: '-0.02em' }}>
                <ReactTyped
                  strings={[
      ...
      {/* Stats Bar */}
      <div className="position-absolute bottom-0 start-0 w-100 py-4 border-top border-dark border-opacity-10 bg-off-white">
        <Container>
